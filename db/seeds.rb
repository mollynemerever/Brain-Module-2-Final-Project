...
p1 = Post.create(title: "Cracking Coding - You Gotta Read This!", content_type: "Book", content_link: "https://www.amazon.com/Cracking-Coding-Interview-Programming-Questions/dp/0984782850?ref_=Oct_BSellerC_2576_0&pf_rd_p=89808df1-4ad8-5c41-9871-2119b4cfd099&pf_rd_s=merchandised-search-6&pf_rd_t=101&pf_rd_i=2576&pf_rd_m=ATVPDKIKX0DER&pf_rd_r=D60Y980XYGANNS2V1PGH&pf_rd_r=D60Y980XYGANNS2V1PGH&pf_rd_p=89808df1-4ad8-5c41-9871-2119b4cfd099", description: "Coding is hard - that's why I recommend this read. It has helped lots of candidates remain calm throughout the interview process.  I like to keep a copy on the coffee table in our lobby to ease the pre-interview nerves!", user_id: u10.id)
p2 = Post.create(title: "Would Definitely Recommend This Podcast", content_type: "Podcast", content_link: "https://jamesaltucher.com/podcast/ramit-sethi-what-does-it-really-mean-to-have-a-rich-life/", description: "This inspired me and left me wanting more! Being rich doesn't always mean you have a lot in your bank account.  In fact, for me it means making breakfast on the weekends with my family and weekly Friday movie nights.", user_id: u12.id)
p3 = Post.create(title: "Found A Gem Of An Article To Revamp Your Emails", content_type: "Article", content_link: "https://www.linkedin.com/pulse/20141121004606-19607530-the-greatest-email-you-ll-ever-send/", description: "Must read - I know we all complain about too many emails but this email you gotta send. Think about emails as quick, to the point notes, that will forever be tracked on a papertrail. Reread before you hit send!", user_id: u3.id)
p4 = Post.create(title: "Feeling Energized After This Podcast", content_type: "Podcast", content_link: "https://itunes.apple.com/us/podcast/charged-life-brendon-burchard/id821746377?mt=2", description: "Changed My Life. Listened to this podcast driving down the coast of California. Maybe it was the ocean talking to me, but I sure did feel inspired.", user_id: u4.id)
p5 = Post.create(title: "Design Your Life - I Did!", content_type: "Book", content_link: "https://www.amazon.com/Designing-Your-Life-Well-Lived-Joyful/dp/1101875321?ref_=Oct_BSellerC_2576_1&pf_rd_p=89808df1-4ad8-5c41-9871-2119b4cfd099&pf_rd_s=merchandised-search-6&pf_rd_t=101&pf_rd_i=2576&pf_rd_m=ATVPDKIKX0DER&pf_rd_r=D60Y980XYGANNS2V1PGH&pf_rd_r=D60Y980XYGANNS2V1PGH&pf_rd_p=89808df1-4ad8-5c41-9871-2119b4cfd099", description: "We often forget that we can design our own lives, create our own paths. This is a great reminder for all of us. Don't let anyone tell you what you can and cannot do.  When I was a student I remember a teacher that told me everyday that I could do whatever I set my mind to.  I didn't appreciate it at the time, but now looking back, I am thankful that those seeds of wisdom were planted in my mind at an early age. ", user_id: u5.id)
...
p7 = Post.create(title: "Five Career Blogs I Enourage Following", content_type: "Article", content_link: "https://www.themuse.com/advice/5-career-blogs-worth-a-read", description: "Read these five articles and share with your colleagues. Feel free to comment with your favorite below.  A lot of people don't know this about me, but I love reading blogs.  I think they are a nice window into the soul, free to read by anyone, an and an excellent way to share knowledge to anyone across the world!", user_id: u6.id)
...
p9 = Post.create(title: "My Friend Eileen Fisher on How I Built This ", content_type: "Podcast", content_link: "https://www.npr.org/2019/02/22/697104124/eileen-fisher-eileen-fisher", description: "My lovely and dearest friend Eileen. She is so dear to me and runs an incredibly socially responsible business. I remember her in our younger days at FIDM - she was a straight A student! Listen and enjoy. xoxo", user_id: u13.id)
p10 = Post.create(title: "Nike Continues to Inspire Me. Phil Knight has lots of wisdom ", content_type: "Book", content_link: "https://www.goodreads.com/book/show/27220736-shoe-dog", description: "I wear Nike shoes all the time but have never really thought about the history of the company until now.  This book is captivating - feels like you are having a conversation with Phil himself.", user_id: u15.id)
p11 = Post.create(title: "Simple Investing Tips - Gotta Start Somewhere", content_type: "Podcast", content_link: "https://www.theinvestorspodcast.com/episodes/marin-katusa-gold/", description: "I worked hard to build my career.  I want to share as much advice with my followers as possible, but sometimes I don't have the time to put pen to paper.  This podcast helps to shed some light on commodity stocks - great place to start.", user_id: u7.id)
...
b18 = Brain.create(user_id: u12.id, post_id: p10.id)
b19 = Brain.create(user_id: u12.id, post_id: p11.id)
b20 = Brain.create(user_id: u12.id, post_id: p11.id)
b21 = Brain.create(user_id: u12.id, post_id: p11.id)
b22 = Brain.create(user_id: u12.id, post_id: p10.id)
b23 = Brain.create(user_id: u12.id, post_id: p9.id)
b24 = Brain.create(user_id: u12.id, post_id: p8.id)
b25 = Brain.create(user_id: u12.id, post_id: p8.id)
b26 = Brain.create(user_id: u12.id, post_id: p1.id)
